...
export class Combo {
    ...
    static findAttribute(combo: Combo, type: AttributeTypeEnum): Attribute[] {
...
export class Item {
    ...
    static findAttribute(item: Item, type: AttributeTypeEnum, itemList: Item[], findCombo: boolean = true): Attribute[] {
...
export class Equipment extends Item {
    ...
    static findAttribute(item: Equipment, type: AttributeTypeEnum, itemList: Item[], findCombo: boolean = true): Attribute[] {
        let attributes: Attribute[] = []
