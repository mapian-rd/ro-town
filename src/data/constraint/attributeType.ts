...
export const physicalAttributeList: Map<AttributeTypeEnum, AttributeType> = new Map([
    ...
    [AttributeTypeEnum.PhysicalBoss, new AttributeType("Dmg to Class Boss")],
    [AttributeTypeEnum.PhysicalMon, new AttributeType("Dmg to Class Normal")],
...
export const magicalAttributeList: Map<AttributeTypeEnum, AttributeType> = new Map([
    ...
    [AttributeTypeEnum.MagicBoss, new AttributeType("Dmg to Class Boss")],
    [AttributeTypeEnum.MagicMon, new AttributeType("Dmg to Class Normal")],
